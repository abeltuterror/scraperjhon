...
# ========== NUEVA FUNCIÓN: scrape por rango de índices dentro de cada página ==========
...
async def main():
    ...
    # Lanzamos dos tareas que procesarán la misma página pero cada una un rango distinto de índices
    # Asumiendo que cada página tiene 10 vacantes (ajusta según sea necesario)
    tarea1 = asyncio.create_task(scrape_rango(0, 5, terminal, scraping_id))   # primeros 5
    tarea2 = asyncio.create_task(scrape_rango(5, 10, terminal, scraping_id))  # siguientes 5
