...
def inferir_nivel(formacion, especializacion):
    ...
    if "TECNICO" in f or "TECNOLOGO" in f:   # normalmente la especialización no define Técnico
...
def generar_documentos(niveles):
    ...
    elif tiene_tecnico:   # solo si no hay niveles universitarios
...
def normalizar_y_guardar():
    ...
    try:
        ...
        print("Extrayendo datos de 'convocatorias' (estado = exitoso)...")
        ...
        for row in rows:
            ...
            # ⚡ Ahora devuelve una lista de niveles
            ...
            item = {
                ...
                "nivel": niveles,                 # ← ahora es un array
                ...
                "documentos": generar_documentos(niveles),   # ← se adapta a la lista
